-- FUNCTION: ow_base_us."aut_qusuarios$obtenerusuariosimple"(text, text)

CREATE OR REPLACE FUNCTION ow_base_us."aut_qusuarios$obtenerusuariosimple"(
	p_prcs text,
	p_usuario text,
...
DECLARE
    ...
    SELECT
        ...
        usuario_usuario, usuario_persn, usuario_clave, persn_email AS usuario_mail, persn_celular AS usuario_celular, usuario_medio_tok, usuario_tipo_aut, usuario_usrcre, usuario_feccre, usuario_estado, usuario_cambio_clave, usuario_avatar,
...
ALTER FUNCTION ow_base_us."aut_qusuarios$obtenerusuariosimple"(text, text)
    OWNER TO ow_base_us;
