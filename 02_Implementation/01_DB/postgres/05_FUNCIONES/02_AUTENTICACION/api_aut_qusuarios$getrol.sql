-- FUNCTION: ow_base_us."api_aut_qusuarios$getrol"(ow_base_us.type_tt_ge_lgtr, text)

CREATE OR REPLACE FUNCTION ow_base_us."api_aut_qusuarios$getrol"(
...
BEGIN
    ...
    v_crta_prcs_gral := 'API_AUT_QUSUARIOS.getRol'
    ...
    SELECT
        ...
        *
        ...
        FROM ow_base_us.aut_qusuarios$getrol(v_crta_prcs_gral, p_rol_rol, v_mensajes)

        INTO F$RESULT_REC_2;

    p_aut_trol := F$RESULT_REC_2.P_AUT_TROL;
...
ALTER FUNCTION ow_base_us."api_aut_qusuarios$getrol"(ow_base_us.type_tt_ge_lgtr, text)
    OWNER TO ow_base_us;
