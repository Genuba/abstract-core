-- FUNCTION: ow_base_us."api_aut_qusuarios$asignarroles"(ow_base_us.type_tt_ge_lgtr, ow_base_us.type_tt_au_usuario, ow_base_us.type_tt_au_rol)

CREATE OR REPLACE FUNCTION ow_base_us."api_aut_qusuarios$asignarroles"(
...
ALTER FUNCTION ow_base_us."api_aut_qusuarios$asignarroles"(ow_base_us.type_tt_ge_lgtr, ow_base_us.type_tt_au_usuario, ow_base_us.type_tt_au_rol)
    OWNER TO ow_base_us;
