-- FUNCTION: ow_base_us."api_aut_qautenticacion$generartokenautenticacion"(ow_base_us.type_tt_ge_lgtr, text, ow_base_us.type_tt_ge_mnsje)

CREATE OR REPLACE FUNCTION ow_base_us."api_aut_qautenticacion$generartokenautenticacion"(
...
BEGIN
    ...
    v_crta_prcs_gral := 'API_AUT_QAUTENTICACION.generarTokenAutenticacion'
    ...
    SELECT
        ...
        *
        ...
        FROM ow_base_us.aut_qautenticacion$generartokenautenticacion(v_crta_prcs_gral, p_usuario, v_mensajes)

        INTO F$RESULT_REC_2;

    p_aut_ttoken := F$RESULT_REC_2.P_AUT_TTOKEN;
...
ALTER FUNCTION ow_base_us."api_aut_qautenticacion$generartokenautenticacion"(ow_base_us.type_tt_ge_lgtr, text, ow_base_us.type_tt_ge_mnsje)
    OWNER TO ow_base_us;
