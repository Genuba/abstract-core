-- FUNCTION: ow_base_us."api_aut_qusuarios$actualizarpersona"(ow_base_us.type_tt_ge_lgtr, ow_base_us.type_tt_au_tpersn)

CREATE OR REPLACE FUNCTION ow_base_us."api_aut_qusuarios$actualizarpersona"(
...
BEGIN
    ...
    v_crta_prcs_gral := 'API_AUT_QUSUARIOS.actualizarPersona'
    ...
    SELECT
        ...
        *
        ...
        FROM ow_base_us.aut_qusuarios$actualizarpersona(v_crta_prcs_gral, p_persona)
...
ALTER FUNCTION ow_base_us."api_aut_qusuarios$actualizarpersona"(ow_base_us.type_tt_ge_lgtr, ow_base_us.type_tt_au_tpersn)
    OWNER TO ow_base_us;
