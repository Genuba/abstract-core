-- FUNCTION: ow_base_us."aut_qusuarios$asignarroles"(text, ow_base_us.type_tt_au_usuario, ow_base_us.type_tt_au_rol)

CREATE OR REPLACE FUNCTION ow_base_us."aut_qusuarios$asignarroles"(
	p_prcs text,
...
BEGIN
    ...
    LOOP
        ...
        FOR j IN 1..COALESCE(array_length(p_troles, 1), 0) LOOP
...
ALTER FUNCTION ow_base_us."aut_qusuarios$asignarroles"(text, ow_base_us.type_tt_au_usuario, ow_base_us.type_tt_au_rol)
    OWNER TO ow_base_us;
