-- FUNCTION: ow_base_us."api_aut_qusuarios$crearrol"(ow_base_us.type_tt_ge_lgtr, ow_base_us.type_tt_au_rol)

CREATE OR REPLACE FUNCTION ow_base_us."api_aut_qusuarios$crearrol"(
...
BEGIN
    ...
    v_crta_prcs_gral := 'API_AUT_QUSUARIOS.crearRol'
    ...
    SELECT
        ...
        *
        ...
        FROM ow_base_us.aut_qusuarios$crearrol(v_crta_prcs_gral, p_aut_trol, v_mensajes)
...
ALTER FUNCTION ow_base_us."api_aut_qusuarios$crearrol"(ow_base_us.type_tt_ge_lgtr, ow_base_us.type_tt_au_rol)
    OWNER TO ow_base_us;
