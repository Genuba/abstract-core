-- FUNCTION: ow_base_us."api_aut_qusuarios$obtenerusuario"(ow_base_us.type_tt_ge_lgtr, text, text)

CREATE OR REPLACE FUNCTION ow_base_us."api_aut_qusuarios$obtenerusuario"(
...
BEGIN
    ...
    v_crta_prcs_gral := 'API_AUT_QUSUARIOS.obtenerUsuario'
    ...
    SELECT
        ...
        *
        ...
        FROM ow_base_us.aut_qusuarios$obtenerusuario(v_crta_prcs_gral, p_usuario, p_usua_clave)
...
ALTER FUNCTION ow_base_us."api_aut_qusuarios$obtenerusuario"(ow_base_us.type_tt_ge_lgtr, text, text)
    OWNER TO ow_base_us;
