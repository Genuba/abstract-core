-- FUNCTION: ow_base_us."api_aut_qusuarios$obtenerpersonaasociadausuario"(ow_base_us.type_tt_ge_lgtr, text)

CREATE OR REPLACE FUNCTION ow_base_us."api_aut_qusuarios$obtenerpersonaasociadausuario"(
...
BEGIN
    ...
    v_crta_prcs_gral := 'API_AUT_QUSUARIOS.obtenerPersonaAsociadaUsuario'
    ...
    SELECT
        ...
        *
        ...
        FROM ow_base_us.aut_qusuarios$getpersonaporusuario(v_crta_prcs_gral, p_usuario)

        INTO F$RESULT_REC_2;

    v_crta_crta_gral := F$RESULT_REC_2.P_COD_RPTA;

    p_tpersona := F$RESULT_REC_2.P_TPERSONA;
...
ALTER FUNCTION ow_base_us."api_aut_qusuarios$obtenerpersonaasociadausuario"(ow_base_us.type_tt_ge_lgtr, text)
    OWNER TO ow_base_us;
