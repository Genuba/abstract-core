-- FUNCTION: ow_base_us."api_aut_qusuarios$eliminarrolesporusuario"(ow_base_us.type_tt_ge_lgtr, text)

CREATE OR REPLACE FUNCTION ow_base_us."api_aut_qusuarios$eliminarrolesporusuario"(
...
BEGIN
    ...
    v_crta_prcs_gral := 'API_AUT_QUSUARIOS.eliminarRolesPorUsuario'
    ...
    SELECT
        ...
        *
        ...
        FROM ow_base_us.aut_qusuarios$eliminarrolesporusuario(v_crta_prcs_gral, p_usuario)
...
ALTER FUNCTION ow_base_us."api_aut_qusuarios$eliminarrolesporusuario"(ow_base_us.type_tt_ge_lgtr, text)
    OWNER TO ow_base_us;
