-- FUNCTION: ow_base_us."api_aut_qusuarios$getallusuarios"(ow_base_us.type_tt_ge_lgtr)

CREATE OR REPLACE FUNCTION ow_base_us."api_aut_qusuarios$getallusuarios"(
...
BEGIN
    ...
    v_crta_prcs_gral := 'API_AUT_QUSUARIOS.getAllUsuarios'
    ...
    SELECT
        ...
        *
        ...
        FROM ow_base_us.aut_qusuarios$getallusuarios(v_crta_prcs_gral)
...
ALTER FUNCTION ow_base_us."api_aut_qusuarios$getallusuarios"(ow_base_us.type_tt_ge_lgtr)
    OWNER TO ow_base_us;
