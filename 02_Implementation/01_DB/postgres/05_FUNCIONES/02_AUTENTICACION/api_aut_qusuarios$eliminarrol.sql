-- FUNCTION: ow_base_us."api_aut_qusuarios$eliminarrol"(ow_base_us.type_tt_ge_lgtr, text)

CREATE OR REPLACE FUNCTION ow_base_us."api_aut_qusuarios$eliminarrol"(
...
BEGIN
    ...
    v_crta_prcs_gral := 'API_AUT_QUSUARIOS.eliminarRol'
    ...
    SELECT
        ...
        *
        ...
        FROM ow_base_us.aut_qusuarios$eliminarrol(v_crta_prcs_gral, p_rol_rol)
...
ALTER FUNCTION ow_base_us."api_aut_qusuarios$eliminarrol"(ow_base_us.type_tt_ge_lgtr, text)
    OWNER TO ow_base_us;
