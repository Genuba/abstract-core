-- FUNCTION: ow_base_us."aut_qusuarios$eliminarrol"(text, text)

CREATE OR REPLACE FUNCTION ow_base_us."aut_qusuarios$eliminarrol"(
	p_prcs text,
	p_rol_rol text,
	OUT p_cod_rta text,
...
BEGIN
    ...
    DELETE FROM ow_base_us.aut_trol
...
ALTER FUNCTION ow_base_us."aut_qusuarios$eliminarrol"(text, text)
    OWNER TO ow_base_us;
