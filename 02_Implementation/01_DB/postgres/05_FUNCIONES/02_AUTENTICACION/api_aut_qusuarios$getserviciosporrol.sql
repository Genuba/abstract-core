-- FUNCTION: ow_base_us."api_aut_qusuarios$getserviciosporrol"(ow_base_us.type_tt_ge_lgtr, text)

CREATE OR REPLACE FUNCTION ow_base_us."api_aut_qusuarios$getserviciosporrol"(
...
BEGIN
    ...
    v_crta_prcs_gral := 'API_AUT_QUSUARIOS.getServiciosPorRol'
    ...
    SELECT
        ...
        *
        ...
        FROM ow_base_us.aut_qusuarios$getserviciosporrol(v_crta_prcs_gral, p_rol_rol)

        INTO F$RESULT_REC_2;

    p_aut_tservicio := F$RESULT_REC_2.P_AUT_TSERVICIO;
...
ALTER FUNCTION ow_base_us."api_aut_qusuarios$getserviciosporrol"(ow_base_us.type_tt_ge_lgtr, text)
    OWNER TO ow_base_us;
