-- FUNCTION: ow_base_us."aut_qusuarios$eliminarserviciorol"(text, text, double precision)

CREATE OR REPLACE FUNCTION ow_base_us."aut_qusuarios$eliminarserviciorol"(
	p_prcs text,
	p_rol_rol text,
...
BEGIN
    ...
    DELETE FROM ow_base_us.aut_tsrol

        WHERE srol_servicio = p_servicio AND srol_rol = p_rol_rol
...
ALTER FUNCTION ow_base_us."aut_qusuarios$eliminarserviciorol"(text, text, double precision)
    OWNER TO ow_base_us;
