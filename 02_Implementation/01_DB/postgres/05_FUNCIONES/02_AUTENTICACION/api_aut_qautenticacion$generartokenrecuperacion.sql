-- FUNCTION: ow_base_us."api_aut_qautenticacion$generartokenrecuperacion"(ow_base_us.type_tt_ge_lgtr, text)

CREATE OR REPLACE FUNCTION ow_base_us."api_aut_qautenticacion$generartokenrecuperacion"(
...
BEGIN
    ...
    v_crta_prcs_gral := 'API_AUT_QAUTENTICACION.generarTokenRecuperacion';
    ...
    SELECT
        ...
        *
        ...
        FROM ow_base_us.aut_qautenticacion$generartokenrecuperacion(v_crta_prcs_gral, p_usuario)
...
ALTER FUNCTION ow_base_us."api_aut_qautenticacion$generartokenrecuperacion"(ow_base_us.type_tt_ge_lgtr, text)
    OWNER TO ow_base_us;
