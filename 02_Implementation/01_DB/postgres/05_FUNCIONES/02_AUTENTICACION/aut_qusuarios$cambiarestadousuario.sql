-- FUNCTION: ow_base_us."aut_qusuarios$cambiarestadousuario"(text, text, text)

CREATE OR REPLACE FUNCTION ow_base_us."aut_qusuarios$cambiarestadousuario"(
	p_prcs text,
	p_usuario text,
	p_estado text,
	OUT p_cod_rta text,
...
ALTER FUNCTION ow_base_us."aut_qusuarios$cambiarestadousuario"(text, text, text)
    OWNER TO ow_base_us;
