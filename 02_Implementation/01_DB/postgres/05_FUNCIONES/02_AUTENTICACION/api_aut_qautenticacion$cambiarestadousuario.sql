-- FUNCTION: ow_base_us."api_aut_qautenticacion$cambiarestadousuario"(ow_base_us.type_tt_ge_lgtr, text, text)

CREATE OR REPLACE FUNCTION ow_base_us."api_aut_qautenticacion$cambiarestadousuario"(
...
BEGIN
    ...
    v_crta_prcs_gral := 'API_AUT_QAUTENTICACION.cambiarEstadoUsuario'
    ...
    SELECT
        ...
        *
        ...
        FROM ow_base_us.aut_qusuarios$cambiarestadousuario(v_crta_prcs_gral, p_usuario, p_estado)
...
ALTER FUNCTION ow_base_us."api_aut_qautenticacion$cambiarestadousuario"(ow_base_us.type_tt_ge_lgtr, text, text)
    OWNER TO ow_base_us;
