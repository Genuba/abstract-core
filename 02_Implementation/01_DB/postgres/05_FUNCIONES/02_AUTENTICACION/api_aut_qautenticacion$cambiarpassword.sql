-- FUNCTION: ow_base_us."api_aut_qautenticacion$cambiarpassword"(ow_base_us.type_tt_ge_lgtr, text, text, text)

CREATE OR REPLACE FUNCTION ow_base_us."api_aut_qautenticacion$cambiarpassword"(
...
BEGIN
    ...
    v_crta_prcs_gral := 'API_AUT_QAUTENTICACION.cambiarPassword'
    ...
    SELECT
        ...
        *
        ...
        FROM ow_base_us.aut_qautenticacion$cambiarpassword(v_crta_prcs_gral, p_usuario, p_actual, p_nuevo)
...
ALTER FUNCTION ow_base_us."api_aut_qautenticacion$cambiarpassword"(ow_base_us.type_tt_ge_lgtr, text, text, text)
    OWNER TO ow_base_us;
