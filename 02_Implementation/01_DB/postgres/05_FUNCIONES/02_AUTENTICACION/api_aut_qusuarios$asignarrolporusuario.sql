-- FUNCTION: ow_base_us."api_aut_qusuarios$asignarrolporusuario"(ow_base_us.type_tt_ge_lgtr, text, text)

CREATE OR REPLACE FUNCTION ow_base_us."api_aut_qusuarios$asignarrolporusuario"(
...
BEGIN
    ...
    v_crta_prcs_gral := 'API_AUT_QUSUARIOS.asignarRolPorUsuario'
    ...
    SELECT
        ...
        *
        ...
        FROM ow_base_us.aut_qusuarios$asignarrolporusuario(v_crta_prcs_gral, p_usuario, p_rol)
...
ALTER FUNCTION ow_base_us."api_aut_qusuarios$asignarrolporusuario"(ow_base_us.type_tt_ge_lgtr, text, text)
    OWNER TO ow_base_us;
