-- FUNCTION: ow_base_us."api_aut_qautenticacion$establecerpassword"(ow_base_us.type_tt_ge_lgtr, text, text)

CREATE OR REPLACE FUNCTION ow_base_us."api_aut_qautenticacion$establecerpassword"(
...
BEGIN
    ...
    v_crta_prcs_gral := 'API_AUT_QAUTENTICACION.establecerPassword'
    ...
    SELECT
        ...
        *
        ...
        FROM ow_base_us.aut_qautenticacion$actualizarclaveusuario(v_crta_prcs_gral, p_usuario, p_clave)
...
ALTER FUNCTION ow_base_us."api_aut_qautenticacion$establecerpassword"(ow_base_us.type_tt_ge_lgtr, text, text)
    OWNER TO ow_base_us;
