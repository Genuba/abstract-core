-- FUNCTION: ow_base_us."api_aut_qusuarios$obtenerpersonapordocumento"(ow_base_us.type_tt_ge_lgtr, text, text)

CREATE OR REPLACE FUNCTION ow_base_us."api_aut_qusuarios$obtenerpersonapordocumento"(
...
BEGIN
    ...
    v_crta_prcs_gral := 'API_AUT_QUSUARIOS.obtenerPersona'
    ...
    SELECT
        ...
        *
        ...
        FROM ow_base_us.aut_qusuarios$getpersonapordocumento(v_crta_prcs_gral, p_tipodoc, p_documento)
...
ALTER FUNCTION ow_base_us."api_aut_qusuarios$obtenerpersonapordocumento"(ow_base_us.type_tt_ge_lgtr, text, text)
    OWNER TO ow_base_us;
