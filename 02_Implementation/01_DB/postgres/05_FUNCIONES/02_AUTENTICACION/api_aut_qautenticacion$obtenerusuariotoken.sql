-- FUNCTION: ow_base_us."api_aut_qautenticacion$obtenerusuariotoken"(ow_base_us.type_tt_ge_lgtr, text, text)

CREATE OR REPLACE FUNCTION ow_base_us."api_aut_qautenticacion$obtenerusuariotoken"(
...
BEGIN
    ...
    v_crta_prcs_gral := 'API_AUT_QAUTENTICACION.obtenerUsuarioToken'
    ...
    SELECT
        ...
        *
        ...
        FROM ow_base_us.aut_qautenticacion$obtenerusuariotoken(v_crta_prcs_gral, p_usuario, p_token)

        INTO F$RESULT_REC_2;

    p_tusuario := F$RESULT_REC_2.P_TUSUARIO;
...
ALTER FUNCTION ow_base_us."api_aut_qautenticacion$obtenerusuariotoken"(ow_base_us.type_tt_ge_lgtr, text, text)
    OWNER TO ow_base_us;
