-- FUNCTION: ow_base_us."api_ge_qmenu$paginainicioporusuario"(ow_base_us.type_tt_ge_lgtr, text)

CREATE OR REPLACE FUNCTION ow_base_us."api_ge_qmenu$paginainicioporusuario"(
...
BEGIN
    ...
    SELECT
        ...
        *
        ...
        FROM ow_base_us.ge_qmenu$paginainicioporusuario(v_crta_prcs_gral, p_usuario)

        INTO F$RESULT_REC_2;

    p_surl_url := F$RESULT_REC_2.P_SURL_URL;
...
ALTER FUNCTION ow_base_us."api_ge_qmenu$paginainicioporusuario"(ow_base_us.type_tt_ge_lgtr, text)
    OWNER TO ow_base_us;
