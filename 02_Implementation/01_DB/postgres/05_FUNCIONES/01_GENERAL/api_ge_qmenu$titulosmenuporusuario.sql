-- FUNCTION: ow_base_us."api_ge_qmenu$titulosmenuporusuario"(ow_base_us.type_tt_ge_lgtr, text)

CREATE OR REPLACE FUNCTION ow_base_us."api_ge_qmenu$titulosmenuporusuario"(
...
BEGIN
    ...
    SELECT
        ...
        *
        ...
        FROM ow_base_us.ge_qmenu$titulosmenuporusuario(v_crta_prcs_gral, p_usuario)

        INTO F$RESULT_REC_2;

    p_tmenu := F$RESULT_REC_2.P_TMENU;
...
ALTER FUNCTION ow_base_us."api_ge_qmenu$titulosmenuporusuario"(ow_base_us.type_tt_ge_lgtr, text)
    OWNER TO ow_base_us;
