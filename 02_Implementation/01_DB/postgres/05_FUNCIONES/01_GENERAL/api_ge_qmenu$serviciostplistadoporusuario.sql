-- FUNCTION: ow_base_us."api_ge_qmenu$serviciostplistadoporusuario"(ow_base_us.type_tt_ge_lgtr, text)

CREATE OR REPLACE FUNCTION ow_base_us."api_ge_qmenu$serviciostplistadoporusuario"(
...
BEGIN
    ...
    SELECT
        ...
        *
        ...
        FROM ow_base_us.ge_qmenu$serviciostplistadoporusuario(v_crta_prcs_gral, p_usuario)
...
ALTER FUNCTION ow_base_us."api_ge_qmenu$serviciostplistadoporusuario"(ow_base_us.type_tt_ge_lgtr, text)
    OWNER TO ow_base_us;
