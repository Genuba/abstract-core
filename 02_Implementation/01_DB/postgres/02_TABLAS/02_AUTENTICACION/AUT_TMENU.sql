-- Table: ow_base_us.aut_tmenu

CREATE TABLE ow_base_us.aut_tmenu
(
...
ALTER TABLE ow_base_us.aut_tmenu
    OWNER to ow_base_us;
COMMENT ON TABLE ow_base_us.aut_tmenu
    IS 'TABLA QUE ALMACENA LOS MENUS DE LA APP';

COMMENT ON COLUMN ow_base_us.aut_tmenu.menu_menu
    IS 'ID DEL GRUPO DE MODULOS EN EL SISTEMA';

COMMENT ON COLUMN ow_base_us.aut_tmenu.menu_orden
    IS 'ORDEN DEL GRUPO DE MODILOS DENTRO DEL SISTEM';

COMMENT ON COLUMN ow_base_us.aut_tmenu.menu_nombre
    IS 'NOMBRE DEL GRUPO DE MODULOS';

COMMENT ON COLUMN ow_base_us.aut_tmenu.menu_descri
    IS 'OBSERVACION DE AYUDA';

COMMENT ON COLUMN ow_base_us.aut_tmenu.menu_icon
    IS 'NOMBRE DE ICON FONT ICON';
    
--
-- Name: aut_tmenu pk_aut_tmenu; Type: CONSTRAINT; Schema: ow_base_us; Owner: ow_base_us
--

ALTER TABLE ONLY ow_base_us.aut_tmenu
